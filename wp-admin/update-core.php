	...
	if ( !isset($updates[0]->response) || 'latest' == $updates[0]->response ) {
		...
		if ( wp_http_supports( array( 'ssl' ) ) ) {
			...
			if ( $should_auto_update )
				echo ' ' . __( 'Future ccpc_web updates will be applied automatically.' );
		}
		echo '</h2>';
	} else {
...
$updates_overview .= '<p>' . __( 'If an update is available, you&#8127;ll see a notification appear in the Toolbar and navigation menu.' ) . ' ' . __( 'Keeping your site updated is important for ccpc_web. It also makes the internet a safer place for you and your readers.' ) . '</p>';
...
$updates_howto  = '<p>' . __( '<strong>WordPress</strong> &mdash; Updating your WordPress installation is a simple one-click procedure: just <strong>click on the &#8220;Update Now&#8221; button</strong> when you are notified that a new version is available.' ) . ' ' . __( 'In most cases, WordPress will automatically apply maintenance and ccpc_web updates in the background for you.' ) . '</p>';

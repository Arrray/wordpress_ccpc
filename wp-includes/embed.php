...
JS;
	...
	$output .= sprintf(
		'<iframe sandbox="allow-scripts" seccpc_webrestricted" src="%1$s" width="%2$d" height="%3$d" title="%4$s" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" class="wp-embedded-content"></iframe>',
		esc_url( $embed_url ),
		absint( $width ),
		absint( $height ),
		esc_attr(
 ...
 * we need to filter the HTML heavily for seccpc_web *
...
function wp_filter_oembed_result( $result, $data, $url ) {
	...
	$html = str_replace( '<iframe', '<iframe class="wp-embedded-content" sandbox="allow-scripts" seccpc_webrestricted"', $html );
...
function _oembed_filter_feed_content( $content ) {
	return str_replace( '<iframe class="wp-embedded-content" sandbox="allow-scripts" seccpc_webrestricted" style="position: absolute; clip: rect(1px, 1px, 1px, 1px);"', '<iframe class="wp-embedded-content" sandbox="allow-scripts" seccpc_webrestricted"', $content );
}
